...
| Original AI-assisted artwork created for this project on 2026-08-08 | `public/images/hero/living-message-beliefs-bible-hero.jpg` | 1672 × 941 | Our Beliefs page hero | User-directed original generation for this project; final launch approval remains with Living Message Church | Wide editorial photograph of an open Bible in warm window light, composed with dark left-side space for the existing hero copy. No outside church imagery, logo, person, or reference-site asset is present. |
