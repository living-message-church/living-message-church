...
- The About navigation presents implemented Our Church, Our Beliefs, Our Pastor, and Our Team destinations, an external Our Outreach handoff, and the staged Our Missions destination. The shared desktop and mobile disclosure behavior remains accessible and closes consistently.
