...
- The primary navigation now separates ministry audiences from general connection pathways. Connect retains Youth, Groups, Marriage & Family, Care, and Worship; the adjacent Ministries dropdown contains Men’s, Women’s, Young Adults, Seniors, and LM Kids, with unimplemented destinations identified as coming soon rather than linked to empty routes.
