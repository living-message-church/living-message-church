...
- Priority route structures remain for About, Youth, Young Adults, Groups, Outreach, and Give. Connect and LMC Kids now have dedicated photography-led experiences, but Kids remains no-indexed while ages, safeguarding, allergies, accessibility, schedules, and ministry leadership await approval. Next Steps, Our Beliefs, Our Pastor, and Our Team have complete indexable routes sourced from their current production pages.
