...
- The primary navigation now separates structured spiritual formation from ministry audiences. The main tab is named Growth and links to a focused Growth Groups experience with anchored 2027 curriculum destinations; the adjacent Ministries dropdown contains Men’s, Women’s, Young Adults, Seniors, and LM Kids, with unimplemented destinations identified as coming soon rather than linked to empty routes.
