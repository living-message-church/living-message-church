...
- Next Steps schedule/registration, the current Our Church identity story, the current public doctrinal statement, and the current Pastor biography/history are approved for temporary use from their production pages. Next Steps operations, final governance/title terminology, pastoral proofreading and personal approval, and current outreach program details remain verification blockers.
