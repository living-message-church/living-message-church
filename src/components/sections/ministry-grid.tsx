      ...
      <div className="card-grid ministry-story-grid">
        {ministries.map((ministry) => (
          <Card key={ministry.id} className="ministry-card">
            <MediaFrame image={homePhotography.ministries[ministry.id]} label={`${ministry.name.value} photography`} ratio="landscape" tone="sage" sizes="(max-width: 48rem) 100vw, (max-width: 70rem) 50vw, 30vw" />
