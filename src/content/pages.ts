...
export const stagedPages: Record<string, PageContent> = {
  ...
  events: page("/events", "Events | Living Message Church", "Explore upcoming public events and gatherings at Living Message Church in Clermont, Florida.", "Events", "Make room for life together.", "Find upcoming gatherings, classes, and ways to connect. Event details and registration stay current through Living Message Church’s Planning Center calendar."),
