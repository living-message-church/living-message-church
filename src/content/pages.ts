...
export const stagedPages: Record<string, PageContent> = {
  ...
  messages: page("/messages", "Messages | Living Message Church", "Watch and explore Bible teaching from Living Message Church by title and category.", "Messages", "Teaching rooted in the text.", "Watch the featured sermon and explore the current production-site archive by title or category while the permanent editorial system is prepared."),
