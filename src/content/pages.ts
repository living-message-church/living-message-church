...
export const stagedPages: Record<string, PageContent> = {
  ...
  live: page("/messages/live", "Church Online | Living Message Church", "Watch Living Message Church online when a service is streaming and explore recent services from the verified YouTube channel.", "Church Online", "Church wherever you are.", "Watch live or explore recent Living Message Church messages."),
