...
export const stagedPages: Record<string, PageContent> = {
  ...
  nextSteps: page("/connect/next-steps", "Next Steps Class | Living Message Church", "Connect, serve, and grow through Next Steps.", "I’m new", "Next Steps Class.", "The current Next Steps schedule and registration path are pending verification."),
