...
const publishedRoutes = ["/", "/plan-your-visit", "/about-living-message-church-clermont", "/about/beliefs", "/about/pastor", "/about/leadership", "/connect/next-steps", "/messages", "/contact"];
